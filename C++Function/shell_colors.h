...
//!        std::cout << C_COLOR(__your_stuff__) << std::endl;
#define FG_REVBLACK(s)     "\033[7m\033[30m" << s << "\033[0m"
#define FG_REVRED(s)       "\033[7m\033[31m" << s << "\033[0m"
#define FG_REVGREEN(s)     "\033[7m\033[32m" << s << "\033[0m"
#define FG_REVYELLOW(s)    "\033[7m\033[33m" << s << "\033[0m"
#define FG_REVBLUE(s)      "\033[7m\033[34m" << s << "\033[0m"
#define FG_REVMAGENTA(s)   "\033[7m\033[35m" << s << "\033[0m"
#define FG_REVCYAN(s)      "\033[7m\033[36m" << s << "\033[0m"
#define FG_REVWHITE(s)     "\033[7m\033[37m" << s << "\033[0m"
